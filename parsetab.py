...
_lr_productions = [
  ...
  ('input -> expr_list','input',1,'p_input','/home/szyman/Studia/tk2/LISPparser.py',25),
  ('expr_list -> expr_list expression','expr_list',2,'p_expr_list','/home/szyman/Studia/tk2/LISPparser.py',29),
  ('expr_list -> expression','expr_list',1,'p_expr_list','/home/szyman/Studia/tk2/LISPparser.py',30),
  ('expression -> ( ID expr_list )','expression',4,'p_expression','/home/szyman/Studia/tk2/LISPparser.py',38),
  ('expression -> ( DEFUN ID list expr_list )','expression',6,'p_expression','/home/szyman/Studia/tk2/LISPparser.py',39),
  ('expression -> ( LOOP expression expr_list )','expression',5,'p_expression','/home/szyman/Studia/tk2/LISPparser.py',40),
  ('expression -> atom','expression',1,'p_expression','/home/szyman/Studia/tk2/LISPparser.py',41),
  ('atom -> INTEGER','atom',1,'p_atom','/home/szyman/Studia/tk2/LISPparser.py',53),
  ('atom -> FLOAT','atom',1,'p_atom','/home/szyman/Studia/tk2/LISPparser.py',54),
  ('atom -> STRING','atom',1,'p_atom','/home/szyman/Studia/tk2/LISPparser.py',55),
  ('atom -> BRACKET expr_list )','atom',3,'p_atom','/home/szyman/Studia/tk2/LISPparser.py',56),
  ('atom -> idname','atom',1,'p_atom','/home/szyman/Studia/tk2/LISPparser.py',57),
  ('idname -> ID','idname',1,'p_idname','/home/szyman/Studia/tk2/LISPparser.py',66),
  ('list -> ( )','list',2,'p_list','/home/szyman/Studia/tk2/LISPparser.py',71),
  ('list -> ( expr_list . expression )','list',5,'p_list','/home/szyman/Studia/tk2/LISPparser.py',72),
  ('list -> ( expr_list )','list',3,'p_list','/home/szyman/Studia/tk2/LISPparser.py',73),
]
